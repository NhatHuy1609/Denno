...
// Query Models Schema
export const UsersQueryParamsDtoSchema = z
  .object({
    name: z.string(),
    email: z.string(),
  ...
  .partial()
  .describe('UsersQueryParamsDtoSchema')

export const UserWorkspacesQueryDtoSchema = z
  .object({
...
export const UserJoinedBoardQueryDtoSchema = z
  .object({
