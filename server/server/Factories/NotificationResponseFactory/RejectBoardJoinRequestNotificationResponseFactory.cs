...
{
    public class RejectBoardJoinRequestNotificationResponseFactory : INotificationResponseFactory
    {
        private readonly ApplicationDBContext _dbContext;
        private readonly IMapper _mapper;

        public RejectBoardJoinRequestNotificationResponseFactory(
        ...
        public async Task<INotificationResponseDto> CreateNotificationResponse(NotificationRecipient notification)
        {
            ...
            var notificationResponse = new RejectBoardJoinRequestNotificationResponse()
            {
                Id = notiDetails.Id,
