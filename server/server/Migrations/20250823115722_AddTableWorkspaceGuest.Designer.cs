...
namespace server.Migrations
{
    ...
    [Migration("20250823115722_AddTableWorkspaceGuest")]
    partial class AddTableWorkspaceGuest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("server.Entities.WorkspaceGuest", b =>
                {
                    b.Property<Guid>("WorkspaceId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("server.Entities.WorkspaceGuest", b =>
                {
                    b.HasOne("server.Entities.AppUser", "Guest")
                        .WithMany("WorkspaceGuests")
