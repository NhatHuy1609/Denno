...
{
    public class InCompleteCardStrategy : IDennoActionStrategy
    {
        private readonly ApplicationDBContext _dbContext;
        private readonly ICardService _cardService;

        public InCompleteCardStrategy(
        ...
        public async Task<DennoAction> Execute(DennoActionContext context)
        {
            ...
            var updatedResult = await _cardService.MarkCardAsInCompletedAsync(updatedCardid);
            ...
            {
                ActionType = ActionTypes.InCompleteCard,
